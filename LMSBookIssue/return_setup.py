...
class LMSBookReturn:
    def __init__(self, driver):
        ...
        self.book_issue = (
            By.XPATH,
            "//button[@data-menu-xmlid='lms_book_issue.lms_book_issue_menu']",
        )
        self.issue_history = (
            By.XPATH,
            "//a[@data-menu-xmlid='lms_book_issue.lms_book_issue_history_menu']",
        )
        ...
        self.state = (
            By.XPATH,
            "//span[contains(@class, 'badge rounded-pill') and (text()='Overdue' or text()='Issued')]",
        )
